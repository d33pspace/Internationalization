...
namespace Internationalization.Controllers
{
    public class CurrenciesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Symbol,Description")] Currency currency)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Symbol,Description")] Currency currency)
        {
            if (id != currency.Id)
            {
                return NotFound();
